...
public class Main {
    ...
    public static void main() {
        ...
        try {
            //反射破坏单例模式
            Class clz = Class.forName("com.perdev.designpattern.singleton.Singleton");
        ...
        try {
            //枚举类，不能使用反射破坏单例模式
            Class clz = Class.forName("com.perdev.designpattern.singleton.Singleton2");
            d("1");
            Constructor<Singleton2> constructor = clz.getDeclaredConstructor(Object.class);
            //e=java.lang.NoSuchMethodException: com.perdev.designpattern.singleton.Singleton2.<init>(java.lang.Object)
